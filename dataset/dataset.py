...
from .all_datasets import isic2019, ICH,CL_ICH
import sys
...
def get_dataset(args):
    if args.dataset == "isic2019":
        ...
        train_dataset = ICH(root, "train_ICH", train_transform)#获取到每个CL任务的数据集
        test_dataset = ICH(root, "test_ICH", val_transform)
